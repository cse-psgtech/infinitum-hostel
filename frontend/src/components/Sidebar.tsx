...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen }) => {
  ...
  const navigation = [
    ...
    { name: 'Add Rooms', href: '/home/add-rooms' },
    { name: 'Accommodation Details', href: '/home/accommodation-details' },
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-gray-900/90 backdrop-blur-xl shadow-2xl shadow-purple-900/20 border-r border-purple-500/20 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
